# InvestorLens India — Operating Manual v2 (15 Jul 2026)
...
- Why this rule exists: Session O lost one of two find/replaces silently, and
  it took a byte-check to notice. Whole files make that failure impossible.
...
- **Quarterly, results season** — metrics / factors / bull-bear refresh per
  company as FY/quarter results land (to be scheduled from Session R).
