...
function renderCompare(){
  ...
  document.getElementById('cmp-sub').textContent = 'Best value in cyan · "—" means not disclosed that way — an empty cell is more honest than an estimate · as of ' + ((cos[0]&&cos[0].as_of)||'Q4 FY26');
