...
function factorsInline(c){
  var tags = c.tech_geo_tags||[];
  if(!tags.length) return '<div class="soon">No live factors are recorded for this company yet.</div>';
  /* Session 1B: a reader meets the words "tailwind" and "risk" here first, and
     could reasonably assume the platform judged them. It did not. tag_type is a
     stored column, written and checked by a person when the factor was recorded. */
  return '<p class="m-note">Each factor below was written down and checked by a person, '
    + 'and carries its source inside the line. The tone \u2014 tailwind, risk or context \u2014 is a '
    + 'stored field on that row: not a live reading, not a score, and not a verdict.</p>'
    + '<div class="tag-row">'+tags.map(function(t,i){
...
function bearList(c){
  ...
  /* Session 1B: a short list is not a safe business. Say so. */
  return '<p class="m-note">These are the risks recorded against this company. '
    + 'A short list does not mean a safe business \u2014 it can equally mean less has been '
    + 'written down yet.</p>'
    + '<div class="bb-col bear"><div class="bb-head">Watch-outs</div><ul>'
